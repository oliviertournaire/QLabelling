...
SET(CPACK_PACKAGE_DESCRIPTION_SUMMARY "QLabelling is an open-source software to label images")
SET(CPACK_PACKAGE_VENDOR "Olivier Tournaire, Mickael Bergem, Victor Zini")
SET(CPACK_PACKAGE_DESCRIPTION_FILE "${CMAKE_CURRENT_SOURCE_DIR}/README.txt")
SET(CPACK_RESOURCE_FILE_LICENSE "${CMAKE_CURRENT_SOURCE_DIR}/Copyright.txt")
SET(CPACK_PACKAGE_VERSION_MAJOR ${QLABELLING_MAJOR_VERSION} )
SET(CPACK_PACKAGE_VERSION_MINOR ${QLABELLING_MINOR_VERSION} )
SET(CPACK_PACKAGE_VERSION_PATCH ${QLABELLING_PATCH_VERSION} )
SET(CPACK_PACKAGE_INSTALL_DIRECTORY "QLabelling")
IF(WIN32 AND NOT UNIX)
  # There is a bug in NSI that does not handle full unix paths properly. Make
  # sure there is at least one set of four (4) backlasshes.
  set(CPACK_NSIS_MUI_ICON "${CMAKE_CURRENT_SOURCE_DIR}\\\\rc\\\\icons\\\\Arrangement_2_32x32.ico")
  set(CPACK_NSIS_MUI_UNIICON "${CMAKE_CURRENT_SOURCE_DIR}\\\\rc\\\\icons\\\\Arrangement_2_32x32.ico")
  ...
  SET(CPACK_NSIS_DISPLAY_NAME "QLabelling")
